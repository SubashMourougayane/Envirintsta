...
public class CustomAdapterTravel extends RecyclerView.Adapter<CustomAdapterTravel.MyViewHolder> {

 //   private ArrayList<DataModel> dataSet;
    public static Travel mainActivity;
    Context context;
    ...
    public CustomAdapterTravel(Context context, List<RowItem> rowItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(Travel.myOnClickListener);
      //  view.setOnLongClickListener(Travel.myOnLongClickListener);
                ...
                switch(index)
                {
                    case 0:
                                                              String str = "File Saved to Internal Storage";
                                                                      ...
                                                                      if (TravelContent.grpcontent.get(listPosition).getType().equals("Images")){
                                                                          ...
                                                                          if (success) {
                                                                              ...
                                                                              try {
                                                                                  final String res = TravelContent.grpcontent.get(listPosition).getAuthor() + TravelContent.grpcontent.get(listPosition).getTime();
                                                                                  System.out.println("Downloading" + res);
                                                                                  final String ff = TravelContent.grpcontent.get(listPosition).getMember_name();
                                                                      ...
                                                                      if (TravelContent.grpcontent.get(listPosition).getType().equals("Audios"))
                                                                      {
                                                                      ...
                                                                      if (TravelContent.grpcontent.get(listPosition).getType().equals("Videos"))
                                                                      {
                                                                      ...
                                                                      if (TravelContent.grpcontent.get(listPosition).getType().equals("Files"))
                                                                      {
                                                                      ...
                                                                      if (TravelContent.grpcontent.get(listPosition).getType().equals("Text"))
                                                                      {
...
//                                                                                  progressDialog.show();
                    ...
                    case 1:
                            ...
                            try {
                                ...
                                if (f.exists()) {
                                    ...
                                    for (int j = 0; j < textcontent.size(); j++) {
                                        if (textcontent.get(j).getMember_name().equals(TravelContent.grpcontent.get(listPosition).getMember_name())) {
                        ...
                        else if (TravelContent.grpcontent.get(listPosition).getType().equals("Images")) {
                        ...
                        else if (TravelContent.grpcontent.get(listPosition).getType().equals("Audios")) {
                        ...
                        else if (TravelContent.grpcontent.get(listPosition).getType().equals("Videos")) {
                        ...
                        else if (TravelContent.grpcontent.get(listPosition).getType().equals("Files")) {
