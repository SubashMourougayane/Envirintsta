...
import bluepanther.envirinsta.Commercial.CommerContent;
import bluepanther.envirinsta.Commercial.Commercial_page1;
import bluepanther.envirinsta.Commercial.Commercial_page2;
import bluepanther.envirinsta.R;
import bluepanther.envirinsta.Reports.Repgroup_tab;


public class CustomAdapterCommer extends RecyclerView.Adapter<CustomAdapterCommer.MyViewHolder> {
 ...
 //   private ArrayList<DataModel> dataSet;
    ...
    public CustomAdapterCommer(Context context, List<RowItem> rowItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(Commercial_page2.myOnClickListener);
            ...
            public void onClicked(int index, BoomButton boomButton) {
                ...
                switch(index)
                {
                    case 0:
                        ...
                        if (CommerContent.grpcontent.get(listPosition).getType().equals("Images")){
                            ...
                            if (success) {
                                ...
                                try {
                                    final String res = CommerContent.grpcontent.get(listPosition).getAuthor() + CommerContent.grpcontent.get(listPosition).getTime();
                                    System.out.println("Downloading" + res);
                                    final String ff = CommerContent.grpcontent.get(listPosition).getMember_name();
                        ...
                        if (CommerContent.grpcontent.get(listPosition).getType().equals("Audios"))
                        {
                        ...
                        if (CommerContent.grpcontent.get(listPosition).getType().equals("Videos"))
                        {
                        ...
                        if (CommerContent.grpcontent.get(listPosition).getType().equals("Files"))
                        {
                        ...
                        if (CommerContent.grpcontent.get(listPosition).getType().equals("Text"))
                        {
