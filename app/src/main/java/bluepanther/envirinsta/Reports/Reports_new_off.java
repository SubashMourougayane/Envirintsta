...
public class Reports_new_off extends AppCompatActivity implements DateRangePickerFragment.OnDateRangeSelectedListener,OnMenuItemClickListener, OnMenuItemLongClickListener {
...
private static final String[] MAIN_CATEGORY = {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DateRangePickerFragment dateRangePickerFragment=
                        DateRangePickerFragment.newInstance(Reports_new_off.this,false);
        ...
        ArrayAdapter adapter = new
                ArrayAdapter(Reports_new_off.this,android.R.layout.simple_list_item_1,categories);
...
//
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            @Override
            public boolean onQueryTextSubmit(String query) {
                Toast.makeText(Reports_new_off.this, query,
                        Toast.LENGTH_LONG).show();
                return false;
            }
            ...
            @Override
            public boolean onQueryTextChange(String newText) {
                Toast.makeText(Reports_new_off.this, newText,
                        Toast.LENGTH_LONG).show();
                return false;
            }
        });
...
//        });
        ...
        circularButton2 = (CircularProgressButton) findViewById(R.id.circularButton2);
        circularButton2.setIndeterminateProgressMode(false);
        circularButton2.setStrokeColor(ContextCompat.getColor(Reports_new_off.this, R.color.colorStroke));
        final int factor = sweepDuration / 100;
        circularButton2.setSweepDuration(sweepDuration);
        circularButton2.setOnClickListener(new View.OnClickListener() {
            @Override
...
//F                cat=text.getText().toString();
                ...
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Reports_new_off.this);
                    builder.setMessage("Please enter a valid date range")
                            .setCancelable(false)
                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                    ...
                    .setPositiveButton("Yes", new
                            DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.putBoolean("islog",false);
                                    editor.commit();
                                    startActivity(new Intent(Reports_new_off.this,
                                            Sign_In.class));
                                    Reports_new_off.this.finish();
                                }
                            })
                    .setNegativeButton("No", new
                            DialogInterface.OnClickListener() {
...
//        mFilter_Adapter = new Filter_Adapter(mArrFilter);
    ...
    private class MyTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            imgprog = ProgressDialog.show(Reports_new_off.this, "Message", "Fetching Data...");
                        ...
                        if (checkdate(date)) {
                            ...
                            if (go && go2) {
                                if (images.target.equals("all")) {
                                    ...
                                    getfiles();
                                    RepContent.grpcontent = new ArrayList<RowItem>(grpcontent);
                                    CustomAdapterGR adapter = new CustomAdapterGR(Reports_new_off.this, grpcontent);
                                    Repgroup_tab.setContent(adapter);
                                    ...
                                    if (flagz) {
                                        ...
                                        getfiles();
                                        RepContent.percontent = new ArrayList<RowItem>(percontent);
                                        CustomAdapterIR adapter = new CustomAdapterIR(Reports_new_off.this, percontent);
                                        Repindi_tab.setContent(adapter);
                                    }
                                }
                            }
            ...
            switch(grpcontent.get(i).getType())
            {
                    ...
                    if (success) {
                        ...
                        storageReference.getFile(files).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                ...
                                Toast.makeText(Reports_new_off.this,"Downloaded img"+lol,Toast.LENGTH_LONG).show();
                                lol++;
                                closei--;
                                if(closei==0)
                                {
                                    ...
                                    {
                                        try {
                                            Toast.makeText(Reports_new_off.this,"Invoked frm img",Toast.LENGTH_LONG).show();
                ...
                case "Audios":
                    ...
                    if(closea==0)
                    {
                        ...
                        if(flagi&&flaga&&flagv&&flagf&&flagt)
                        {
                            Toast.makeText(Reports_new_off.this,"Invoked frm aud",Toast.LENGTH_LONG).show();
                ...
                case "Videos":
                    ...
                    if(closev==0)
                    {
                        ...
                        if(flagi&&flaga&&flagv&&flagf&&flagt)
                        {
                            Toast.makeText(Reports_new_off.this,"Invoked frm vid",Toast.LENGTH_LONG).show();
                ...
                case "Files":
                    ...
                    if(closef==0)
                    {
                        ...
                        if(flagi&&flaga&&flagv&&flagf&&flagt)
                        {
                            Toast.makeText(Reports_new_off.this,"Invoked frm fil",Toast.LENGTH_LONG).show();
                    ...
                    fb_db.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(closet==0)
                            {
                                ...
                                {
                                    try {
                                        Toast.makeText(Reports_new_off.this,"Invoked frm txt",Toast.LENGTH_LONG).show();
